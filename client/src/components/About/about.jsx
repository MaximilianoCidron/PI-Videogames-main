      ...
      <div className={styles.container}>
        <div className={styles.about}>
          ...
          <p>
            ...
            . In order to map all the different videogames, this app consumes
            data from{" "}
            <a
            ...
            . The user can create new videogames, filter them by platform or
            genre and order them by name or rating. Future projects will include
            creating a log-in system and a user profile, where people will be
            able to save their favorite games, make guides about them and share
